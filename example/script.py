...
def main(input_data_file, chrom_size_file, compare_list_file, window_size, bin_size, chroms_to_load,
    ...
    sample_data_dict = chia_rep.read_data(input_data_file, chrom_size_file, chroms_to_load,
    ...
    chia_rep.preprocess(sample_data_dict, both_peak_support=False, 
                        output_dir=output_dir, diagnostic_plots=diagnostic_plots)
    
    scores_unweighted, _ = chia_rep.compare(sample_data_dict, 
    ...
    chia_rep.output_to_csv(None, scores_unweighted,
